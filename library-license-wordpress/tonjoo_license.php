...
if ( !class_exists('tonjoo_license') )
{
	...
	class tonjoo_license
	{
		...
		function RegisterKey($data = '')
		{
			...
			$url 	= "http://tonjoostudio.com/manage/ajax/activateCode?code=".urlencode($new_parameter);
		...
		function unRegisterKey($data = '')
		{
			...
			$url 	= "http://tonjoostudio.com/manage/ajax/deactivateCode?code=".urlencode($new_parameter);
			$r 		= tonjoo_license::urlStatus($url);
		...
		function getStatus($data = '')
		{
			...
			$url 	= "http://tonjoostudio.com/manage/ajax/getStatus?code=".urlencode($new_parameter);
			$r 		= tonjoo_license::urlStatus($url);
		...
		function getUpdater($data = array())
		{
			...
			$status = (array) $status;
			$r 	= tonjoo_license::urlStatus('http://tonjoostudio.com');
